    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 relative overflow-hidden">
      ...
      <div className="z-10 w-full max-w-md p-8 bg-white/20 backdrop-blur-2xl rounded-2xl shadow-glass border border-white/30 text-white">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-200 mt-2">Login to manage the smart bins</p>
        </div>
        ...
        <div className="mt-6 text-center text-sm text-gray-200">
          ...
          <button onClick={onSwitchToRegister} className="text-primary hover:text-white font-bold transition-colors underline">
            Register here
          </button>
        </div>
      </div>
